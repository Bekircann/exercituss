module.exports = {
    ...
    token: "MTEzNTU2ODE1MjM4MjY4MTE3MA.GHhLI9.l3nIGmAOmHYFLbaQ1izogBpMpgwRde5_zVLkXc", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "822824711641628752", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1008871953483972638", // Ses Kanal ID'si
    presence: "Bekircan :heart: Exercitus", //Botun Durumu
    footer: "Bekircan & Exercitus", //Embedların Footer Yazısı
    botOwners: ["696061560912740513"], //Bot Sahibinin ID'si
    prefix: "!", //Botun Prefix'i 
    manemoji: "♂️", //Erkek Emojisi
    womanemoji: "♀️", //Kadın Emojisi
    tagSymbol: "そ", //Sunucunun Taglı İsim Sembolu => Eğer Tagınız Yoksa Boş Bırakın Veya "•" Kalsın
    normalSymbol: "そ", //Normal Kayıt Olucak Kullanıcıların Başına Gelicek Sembol
    symbolBeş: "-", //Kayıt Esnasında İsim Ve Yaş'ı Ayıran Çizgi
    minageAge: 13, //En Düşük Kayıt Edilebilir Yaş
    ...
    mongoURL: "mongodb+srv://lrows:kerem2020@cluster0.urdbdmu.mongodb.net/", //MongoDB URL'niz
    ...
    taskSystem: true, // Görev Sisteminin Aktif Veya Deaktif Hale Getirir - true = Aktif / false = Deaktif

    staffs: ["1004838523297337405"], // Yetkililerin Rol ID'leri ["55555","55555"] Şeklinde Girilir

    parents: { // Kategorilerin ID'leri ["55555","55555"] Şeklinde Çoklu Girilebilir
        publicParents: ["1018564078022701096"],
        registerParents: ["1018484688261758986"],
        solvingParents: ["1043930178834944030"],
        privateParents: ["822824712429109274"],
        aloneParents: ["1135573471297028137"],
        funParents: ["1018561783604195338"]
    },
